...
//Checkbox pour le sens du chenillar
...
socket.on('temp', function(msg){
  $('#lvltemp').replaceWith('<p id="lvltemp">Temp.<br/>'+msg+' °C</p>');
});

socket.on('CO', function(msg){
  $('#lvlCO').replaceWith('<p id="lvlCO">CO2<br/>'+msg+' ppm</p>');
});

socket.on('humide', function(msg){
  $('#lvlhumid').replaceWith('<p id="lvlhumid">Humi.<br/>'+msg+' %</p>');
});
...
//Checkbox pour mode rainbow candle
...
//Checkbox pour effet clignotant
...
//Checkbox pour connecter le serveur à la bougie
